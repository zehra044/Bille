...
export declare const PlatformPressable: React.ForwardRefExoticComponent<Omit<PressableProps, "onPress" | "style"> & {
    href?: string;
    pressColor?: string;
    pressOpacity?: number;
    hoverEffect?: HoverEffectProps;
    ...
    onPress?: (e: React.MouseEvent<HTMLAnchorElement, MouseEvent> | GestureResponderEvent) => void;
    children: React.ReactNode;
} & React.RefAttributes<Animated.LegacyRef<import("react-native").View> | import("react-native").View>>;
export {};
