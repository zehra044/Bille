...
var _useIsScreenReaderEnabled = require("../../useIsScreenReaderEnabled");
...
const Pressable = props => {
  ...
  const isScreenReaderEnabled = (0, _useIsScreenReaderEnabled.useIsScreenReaderEnabled)();
  (0, _react.useEffect)(() => {
    const configuration = (0, _stateDefinitions.getStatesConfig)(handlePressIn, handlePressOut, isScreenReaderEnabled);
  ...
  .cancelsTouchesInView(false).onTouchesDown(event => {
    ...
    if (_reactNative.Platform.OS === 'android' && !isScreenReaderEnabled) {
