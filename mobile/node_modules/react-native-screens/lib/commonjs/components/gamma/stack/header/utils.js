...
exports.findMenuElementById = findMenuElementById;
exports.findMenuElementByIdInItems = findMenuElementByIdInItems;
exports.validateMenuCallbacks = validateMenuCallbacks;
function findMenuElementByIdInItems(items, id) {
...
function findMenuElementById(menu, id) {
  if (menu.id === id) {
    return menu;
  }
  if (menu.type === 'menu') {
...
function validateMenuCallbacks(menu) {
