...
export function resolveNativeDetents(detents) {
  if (!detents) {
    return undefined;
  }
...
export function resolveInitialDetentIndex(initialDetentIndex, detentsCount = 0) {
...
export function resolveNativeCornerRadius(radius) {
 ...
 */
export function resolveLargestUndimmedDetentIndex(largestUndimmedDetent, detentsCount = 0) {
