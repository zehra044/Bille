...
export type TabsBottomAccessoryProps = ViewProps & {
    onEnvironmentChange?: ((event: NativeSyntheticEvent<TabsBottomAccessoryEnvironmentChangeEvent>) => void) | undefined;
};
//# sourceMappingURL=TabsBottomAccessory.types.d.ts.map