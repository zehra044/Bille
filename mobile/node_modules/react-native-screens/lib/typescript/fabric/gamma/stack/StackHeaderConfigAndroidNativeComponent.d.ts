...
type StackHeaderToolbarMenuElementUpdateNativeAndroid = StackHeaderToolbarMenuElementOptionsAndroid & {
    id: string;
};
export interface NativeCommands {
    updateToolbarMenuElements: (viewRef: React.ComponentRef<ComponentType>, updates: StackHeaderToolbarMenuElementUpdateNativeAndroid[]) => void;
}
