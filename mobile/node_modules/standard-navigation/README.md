...
This package only contains minimal helpers and types. The actual implementation of integrating with this API should live in respective libraries (e.g. [React Navigation](https://reactnavigation.org/docs/standard-navigator), [Expo Router](https://docs.expo.dev/router/advanced/custom-navigators/#integrate-an-existing-navigator-library-authors), etc.).
